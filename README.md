...
|[Document Explorer Custom Lambda](samples/document-explorer-custom-qa/)| This sample provides an end-to-end experience that allows a user to ingest documents into a knowledge base, then summarize and ask questions against those documents. This is a variant of the Document Explorer sample that passes in custom Lambda code that allows Q&A against multiple documents at a time. | Backend + Frontend |TypeScript for Backend, Python for Frontend ([Streamlit](https://streamlit.io/))|
