...
class ApiGatewayConstruct(Construct):
    ...
    def add_method(
        ...
        integration: typing.Optional[apigateway.Integration] = None,
        method_responses: typing.Optional[
            typing.Sequence[
                typing.Union["MethodResponse", typing.Dict[builtins.str, typing.Any]]
            ]
        ] = None,
    ):
        ...
        for method in self.rest_api.methods:
            ...
            if method.http_method == "OPTIONS":
                ...
                resource.add_property_override(
                    "AuthorizerId", self.cognito_authorizer.authorizer_id
                )
