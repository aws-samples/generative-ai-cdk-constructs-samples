 ...
 */
// Adding declaration for AudioWorkletProcessor class and registerProcessor method, because typescript does not know them
...
class ExpandableBuffer {
  ...
  public read(destination: Float32Array): void {
    let copyLength = 0;
