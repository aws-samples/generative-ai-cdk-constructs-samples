...
export interface AnalyzeRepoFunctionProps {
...
export class AnalyzeRepoFunction extends lambda_python.PythonFunction {
  constructor(scope: Construct, id: string, props: AnalyzeRepoFunctionProps) {
    super(scope, id, {
      entry: path.resolve(
        __dirname,
        "..",
      ...
      index: "amzn_code_expert_code_expert/lambda_handlers/analyze_repo.py",
    ...
    props.bedrockBatchBucket.grantWrite(this);
